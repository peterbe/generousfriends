...
SECRET_KEY = 'tt^&89z@mwguk3z(61wl6n2mm@(u2wf3$5*6olh4x)#^$4wn78'
...
BALANCED_TRANSACTION_PERCENTAGE = 2.9
BALANCED_TRANSACTION_AMOUNT = Decimal('0.30')
PAYMENT_TRANSACTION_PERCENTAGE = BALANCED_TRANSACTION_PERCENTAGE + 0.6
PAYMENT_TRANSACTION_AMOUNT = BALANCED_TRANSACTION_AMOUNT + Decimal('0.70')  #$

TRACEBACKS_ON_500 = False

PROJECT_TITLE = 'Wish List Granted'
PROJECT_STRAPLINE = 'Get What You REALLY Want'
