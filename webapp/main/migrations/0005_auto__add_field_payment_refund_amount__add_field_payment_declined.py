...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Payment.refund_amount'
        db.add_column(u'main_payment', 'refund_amount',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=5, decimal_places=2),
                      keep_default=False)

        # Adding field 'Payment.declined'
        db.add_column(u'main_payment', 'declined',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Payment.refund_amount'
        db.delete_column(u'main_payment', 'refund_amount')

        # Deleting field 'Payment.declined'
        db.delete_column(u'main_payment', 'declined')


    models = {
        u'main.item': {
            'Meta': {'object_name': 'Item'},
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 17, 0, 0)'}),
            ...
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'c76e21e7'", 'max_length': '8'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 17, 0, 0)'}),
        ...
        u'main.verification': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'78e7ffb492124914'", 'max_length': '16'}),
            'wishlist': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Wishlist']"})
        },
        u'main.wishlist': {
            ...
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'2a5afd8e'", 'max_length': '8'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 17, 0, 0)'}),
