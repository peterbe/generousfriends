...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Wishlist.unsubscribe_reminders'
        db.add_column(u'main_wishlist', 'unsubscribe_reminders',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Wishlist.unsubscribe_reminders'
        db.delete_column(u'main_wishlist', 'unsubscribe_reminders')
    ...
    models = {
        u'main.item': {
            ...
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'4b0ef62e'", 'max_length': '8'}),
        ...
        u'main.verification': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'275c4c6b70a44272'", 'max_length': '16'}),
            'wishlist': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Wishlist']"})
        },
        u'main.wishlist': {
            ...
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'5ad16566'", 'max_length': '8'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 3, 0, 0)'}),
