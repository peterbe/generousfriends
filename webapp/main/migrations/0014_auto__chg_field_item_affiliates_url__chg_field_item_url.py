...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.affiliates_url'
        db.alter_column(u'main_item', 'affiliates_url', self.gf('django.db.models.fields.URLField')(max_length=400, null=True))

        # Changing field 'Item.url'
        db.alter_column(u'main_item', 'url', self.gf('django.db.models.fields.URLField')(max_length=400))

    def backwards(self, orm):

        # Changing field 'Item.affiliates_url'
        db.alter_column(u'main_item', 'affiliates_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Item.url'
        db.alter_column(u'main_item', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))

    models = {
        u'main.item': {
            'Meta': {'object_name': 'Item'},
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 23, 0, 0)'}),
            'affiliates_url': ('django.db.models.fields.URLField', [], {'max_length': '400', 'null': 'True'}),
            'cancelled': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'closed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'closed_notes': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            ...
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'aaf5bab4'", 'max_length': '8'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 23, 0, 0)'}),
        ...
        u'main.verification': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'644924e52bfb4827'", 'max_length': '16'}),
            'wishlist': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Wishlist']"})
        },
        u'main.wishlist': {
            ...
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'17b8e96f'", 'max_length': '8'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 23, 0, 0)'}),
            'mugshot': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '100'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'public': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'ship_to': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'unsubscribe_reminders': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
