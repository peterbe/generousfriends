...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SplitExperiment'
        db.create_table(u'main_splitexperiment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
            ('template', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('success', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'main', ['SplitExperiment'])


    def backwards(self, orm):
        # Deleting model 'SplitExperiment'
        db.delete_table(u'main_splitexperiment')


    models = {
        u'main.item': {
            'Meta': {'object_name': 'Item'},
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 26, 0, 0)'}),
            'affiliates_url': ('django.db.models.fields.URLField', [], {'max_length': '400', 'null': 'True'}),
            'amazon_api_converted': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'d859f858'", 'max_length': '8'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 26, 0, 0)'}),
        ...
        u'main.splitexperiment': {
            'Meta': {'object_name': 'SplitExperiment'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
            'success': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
        ...
        u'main.verification': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'8908ef3a5588435b'", 'max_length': '16'}),
            'wishlist': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Wishlist']"})
        },
        u'main.wishlist': {
            ...
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'be3ef125'", 'max_length': '8'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 26, 0, 0)'}),
