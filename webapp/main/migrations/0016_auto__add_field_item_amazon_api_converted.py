...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.amazon_api_converted'
        db.add_column(u'main_item', 'amazon_api_converted',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        for i in orm['main.Item'].objects.all():
            i.amazon_api_converted = False
            i.save()


    def backwards(self, orm):
        # Deleting field 'Item.amazon_api_converted'
        db.delete_column(u'main_item', 'amazon_api_converted')
    ...
    models = {
        u'main.item': {
            ...
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'9c0235f1'", 'max_length': '8'}),
        ...
        u'main.verification': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'dd23a5a727a54bd5'", 'max_length': '16'}),
            'wishlist': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Wishlist']"})
        },
        u'main.wishlist': {
            ...
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'69b765a8'", 'max_length': '8'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 26, 0, 0)'}),
