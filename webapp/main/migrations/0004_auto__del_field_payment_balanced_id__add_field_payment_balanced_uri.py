...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Payment.balanced_uid'
        db.add_column(u'main_payment', 'balanced_uri',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Payment.balanced_uid'
        db.delete_column(u'main_payment', 'balanced_uri')
    ...
    models = {
        u'main.item': {
            ...
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'a3280af2'", 'max_length': '8'}),
        ...
        u'main.verification': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'2a0a4d899aa94f7f'", 'max_length': '16'}),
            'wishlist': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Wishlist']"})
        },
        u'main.wishlist': {
            ...
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'aad747d1'", 'max_length': '8'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 17, 0, 0)'}),
