...
urlpatterns = patterns(
    ...
    url(r'^inboundemail/$',
        views.inbound_email,
        name='inbound_email'),
   url(r'^(?P<identifier>[a-f0-9]{10})/$',
        views.wishlist_home,
        name='wishlist'),
    url(r'^(?P<identifier>[a-f0-9]{10})/pick-one/$',
        views.wishlist_admin,
        name='wishlist_admin'),
    url(r'^(?P<identifier>[a-f0-9]{10})/your-name/$',
        views.wishlist_your_name,
        name='wishlist_your_name'),
    url(r'^(?P<identifier>[a-f0-9]{10})/your-message/$',
        views.wishlist_your_message,
        name='wishlist_your_message'),
    url(r'^(?P<identifier>[a-f0-9]{10})/already-set-up/$',
        views.wishlist_taken,
        name='wishlist_taken'),
    url(r'^(?P<identifier>[a-f0-9]{3,10})/$',
        views.wishlist_home,
        {'fuzzy': True},
        name='wishlist_fuzzy'),
 )
